...
public class Loops {
    ...
    public static int digitNumber(int n) {
        ...
        // Если число равно 0, то оно содержит 1 цифру
        if (n == 0) {
            return 1;
        }
    ...
    public static int fib(int n) {
        if (n <= 0) {
            return 0; // Если n меньше или равно 0, возвращаем 0
        }
        if (n == 1 || n == 2) {
        ...
        int a = 1; // fib(1)
        int b = 1; // fib(2)
        int c = 0; // Переменная для хранения текущего числа Фибоначчи

        for (int i = 3; i <= n; i++) {
            c = a + b; // Считаем текущее число Фибоначчи
            a = b; // Сдвигаем a на следующее число
            b = c; // Сдвигаем b на текущее число
        }

        return c; // Возвращаем n-ное число Фибоначчи
    }
